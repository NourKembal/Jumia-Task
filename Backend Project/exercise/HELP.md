...
* The following dependency is not known to work with Spring Native: 'Rest Repositories'. As a result, your application may not work as expected.
...
```
$ docker run --rm exercise:0.0.1-SNAPSHOT
```
